...
public class TestHBaseGetThread implements Runnable {
	...
	public TestHBaseGetThread(IRegionServer rsStub,String tableName,String[] args) {
...
//					System.exit(0);
					TestPutAndGet.updateGetCounter(1);
				}

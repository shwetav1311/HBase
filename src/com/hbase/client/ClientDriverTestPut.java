...
public class ClientDriverTestPut extends Thread{
	...
	*/
	...
	public ClientDriverTestPut(Integer id)
	{
		this.id = id;
	}
	...
	public void run() {
		...
		while (start <= totalEntries) {
			...
			for (int i = 0; i < numTables; i++) {
				...
				putTable(start.toString(), tableInput.get(1), tableInput);
			}
			start++;
...
//	System.out.println("ip "+str);
	...
	public  void getTable(String tableName,String[] args)
	{
